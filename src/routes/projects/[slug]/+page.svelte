...
<div class="border-b border-neutral-300 px-4 sm:px-10 lg:px-16">
    <div class="mx-auto lg:max-w-7xl border-l border-r border-neutral-300 min-h-64 relative flex flex-col lg:flex-row">
        ...
        <div class="p-3 border-t lg:border-t-0 lg:border-l border-neutral-300 items-center justify-center flex">
            <img src={project.image} alt={project.title} class="aspect-[1.531/1] w-full md:min-w-md md:w-md" />
        </div>
    </div>
</div>